                          ...
                          <form action="#">
                            ...
                            >
                              ...
                              <div class="date-list">
                                <ul>
                                  <li>
                                    <a href="#" class="btn date-btn">Today</a>
                                  </li>
                                  <li>
                ...
                <div class="row align-items-center">
                  <div class="col-lg-8 col-md-8">
                    <div class="invoices-tabs">
                      <ul>
                        <li>
                          <a href="invoices.html" class="active">All Invoice</a>
                        </li>
            ...
            <div class="col-xl-3 col-sm-6 col-12">
              <div class="card inovices-card">
                <div class="card-body">
                  <div class="inovices-widget-header">
                    <span class="inovices-widget-icon">
                      <img src="as\sets/img/icons/invoices-icon4.svg" alt="" />
                    </span>
                    <div class="inovices-dash-count">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            <a href="view-invoice.html" class="invoice-link"
                              >IN093439#@09</a>
                            ...
                            <div class="dropdown dropdown-action">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a
                                  class="dropdown-item"
                                  href="javascript:void(0);"
                                  ><i class="far fa-check-circle me-2"></i>Mark
                                  as sent</a>
